...
class Car {
	/**
	 ...
	 $m = make id
	 **/
	function __construct($r = null, $m = null) {
		$this -> r = $r;
		$this -> m = $m;
	}
	...
	public function checkNotExist() {
		$count = ORM::for_table('rule-model') -> where('rule', $this -> r) -> where('model', $this -> m) -> count();
